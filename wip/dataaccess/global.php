...
function showDiscussionArguments($data_obj) {
	foreach($data_obj as $data) {
							...
							<div class=\"discuss_public_opinion_container\" {$no_evidence_article_formatting}>Public opinion: &nbsp;&nbsp;&nbsp;<img src=\"../images/plus.png\" /><a href=\"#\" id=\"f{$data['cpd_id']}\" class=\"agree_disagree\" onclick=\"return false\" style='font-style:italic;font-size:11px;color:#2e52a4'>add yours</a>
							";
