    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
		...
		<div id="stats_box" class="corner">
			...
			foreach($comments as $key => $value) {
				echo "<span style='font-style:italic;font-size:90%'><a href='http://www.participie.com/wip/talkingpoints/?p=$key'><span style='font-family:Revalia'>&ldquo;</span>" . $value . "<span style='font-family:Revalia'>&rdquo;</span></a></span><br />";
			}
			echo "</div>";
			?>
		</div>
