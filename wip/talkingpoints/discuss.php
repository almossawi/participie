...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<meta property="og:title" content="Participie.com - Help decide what the candidates should be clarifying their positions about!" /> 
  ...
  (function() {
	...
	<body style="background-image:url(../images/blackstrip.jpg);background-color:#e6e6dc;background-position:50% 0px">
		...
		<div id="sticky">
			...
			<br /><span id="bake_or_discuss"><a href="/wip/talkingpoints/" class="not_selected">BAKE</a> &middot; <a href="/wip/talkingpoints/discuss.php" class="selected">DISCUSS</a></span></label>
		</div>
