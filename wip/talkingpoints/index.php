...
<script type="text/javascript">
  ...
  (function() {
	...
	<body style="background-image:url(../images/blackstrip.jpg);background-color:#e6e6dc;background-position:50% 0px">
		...
		<div class="dim"></div>
		<label style="font-family: Georgia, Times, Arial;font-size:26px;color:white;position:absolute;left:260px;top:22px;width:680px;text-align:center">Candidates should clarify their position with respect to…
		<br /><span id="bake_or_discuss"><a href="/wip/talkingpoints/" class="selected">BAKE</a> &middot; <a href="/wip/talkingpoints/discuss.php" class="not_selected">DISCUSS</a></span></label>
		...
		<div style="float:left;width:450px">
			...
			<div id="overview_box" style="top:470px">
				<h2 style="position:relative;top:-2px;margin-top:0;padding-top:0;cursor:pointer">Details...</h2>
		...
		<div id="rhs_container" style="height:750px">
			<!--<div id="talk">
