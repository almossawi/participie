...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  (function() {
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
		...
		<label style="font-family: Georgia, Times, Arial;font-size:34px;color:white;position:absolute;left:360px;top:20px;width:500px;text-align:center">Talking Points Pies</label>
