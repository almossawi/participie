...
if(isset($_POST)) {
	...
	$query = "INSERT INTO `cooked_pies_topics_to_discuss` (`politics`,`state`,`gender`,`zip`, `age`, `pie`, `ip`, `time`, `comment`, `slice_war`, `slice_gay`, `slice_mar`, `slice_edu`, `slice_hel`, `slice_eco`, `slice_gun`, `slice_pri`, `slice_glo`) " .
		"VALUES (" .
