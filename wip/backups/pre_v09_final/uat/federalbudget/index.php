...
<script type="text/javascript">
  ...
  (function() {
	...
	<body style="background-image:url(../images/blackstrip.jpg);background-color:#e6e6dc;background-position:50% 0px">
		...
		<label style="font-family: Georgia, Times, Arial;font-size:34px;color:white;position:absolute;left:360px;top:20px;width:500px;text-align:center">Federal Budget Pie</label>
		<div style="float:left;width:450px">
			...
			<div id="overview_box">
				<h2 style="position:relative;top:-2px;margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:0">Details...</h2>
