	...
	<body style="background-image:none;background-color:#e6e6dc;background-position:50% 4px">
		...
		<div style="width:800px;height:400px;margin-left:-400px;margin-top:-175px;left:50%;top:30%;position:absolute;text-align:center;border:0px solid black">
			<div style="position:absolute;left:0;top:100px">
				<div class="corner" style="position:relative;top:80px;width:800px;height:300px;background-color:white;border:0px solid #cccccc;text-align:left;padding:10px">
					<p style="margin-top:0;font-size:17px;color:#2e2e2e"><strong>Our privacy policy</strong></p>
					<p style="font-size:15px;color:#2e2e2e">Participie.com respects your privacy.  We don't ask for nor store any personal information about you.  If you choose to submit your pie, we store the demographic information that you provide and the IP address that the request came from.  This is just to help us spot possible attempts to game the website.</p>
					<p style="font-size:15px;color:#2e2e2e">We use typical Web analytics software to know where visitors come from, and may use to supplement the results of any analysis that we do with the data.</p>
					<p style="font-size:15px;color:#2e2e2e">We will never sell your data to a third-party without your knowledge though we do intend to use the data we collect with other non-profit organizations.</p>
					<p style="font-size:15px;color:#2e2e2e">Participie.com reserves the right to change this policy at its discretion.  Sorry, that came off a bit strong, but our lawyers insisted. Well, we don't really have laywers, oh well...</p>					
				</div>
