...
?>
   <div class="trail-notify">
        <h1><?php _e( 'Buy Cloriato Theme PRO!', 'cloriato'); ?></h1>
        <p><?php _e( 'You are Using the Lite Version of Cloriato Theme. Upgrade to Pro for exciting features, Home Page Slider, Contact Page Template, priority updates and more.', 'cloriato'); ?> </p>
        <a href="http://www.inkthemes.com/wp-themes/cloriato-wordpress-theme/" target="blank"><?php _e( 'Upgrade to Cloriato Theme PRO &rarr;', 'cloriato'); ?></a>

    </div>
<div class="wrap" id="of_container">
  <div id="of-popup-save" class="of-save-popup">
    <div class="of-save-save"><?php _e( 'Options Updated', 'cloriato'); ?></div>
  </div>
  <div id="of-popup-reset" class="of-save-popup">
    <div class="of-save-reset"><?php _e( 'Options Reset', 'cloriato'); ?></div>
  </div>
  <form action="" enctype="multipart/form-data" id="ofform">
    <div id="header">
      <div class="logo">
        <h2><?php echo $themename; ?> <?php _e( 'Options', 'cloriato'); ?></h2>
      </div>
...
<script type="text/javascript" language="javascript">
		jQuery(document).ready(function(){
			...
			//Color Picker
			<?php $options = inkthemes_get_option('of_template');
...
function inkthemes_optionsframework_uploader_function($id,$std,$mod){
	...
	if($mod != 'min') { 
			$val = $std;
            if ( inkthemes_get_option( $id ) != "") { $val = inkthemes_get_option($id); }
