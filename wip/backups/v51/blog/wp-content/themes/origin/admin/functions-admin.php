...
function origin_admin_scripts( $hook_suffix ) {
    ...
    if ( $theme_settings_page == $hook_suffix ) {
	    ...
	    /* Enqueue Scripts */
	    wp_register_script( 'origin_functions-admin', get_template_directory_uri() . '/admin/functions-admin.js', array( 'jquery', 'media-upload', 'thickbox', 'farbtastic' ), '1.0', false );
	    wp_enqueue_script( 'origin_functions-admin' );
