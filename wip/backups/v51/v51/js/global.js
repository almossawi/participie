...
function mouseOnElementMini(node) {
	if(node.label != "Unallocated") {
		var label_content = "<span style='font-size:75%'><strong>" + node.label + "</strong><br />" + Math.round(node.size*100)/100 + "%</span>";
...
//	console.log($("#pie_data_44").html());
//var d = '{"name": "US_Budget","children": [{"name": "50","label": "National Defense","size": 20,"color": "#6B5248"},{"name": "250","label": "General Science, Space and Technology","size": 1.5,"color": "#637939"},{"name": "500","label": "Education Training, Employment and Social Services","size": 3.5,"color": "#8ca252"},{"name": "270","label": "Energy","size": 1.5,"color": "#b68c3b"},{"name": "300","label": "Natural Resources and Environment","size": 1,"color": "#bd9e39"},{"name": "400","label": "Transportation","size": 2.5,"color": "#e7ba52"},{"name": "450","label": "Community and Regional Development","size": 1.5,"color": "#e7cb94"},{"name": "350","label": "Agriculture","size": 1.5,"color": "#7b4173"},{"name": "370","label": "Commerce and Housing Credit","size": 2,"color": "#a55194"},{"name": "550","label": "Health","size": 10,"color": "#6b6ecf"},{"name": "570","label": "Medicare","size": 12,"color": "#9c9ede"},{"name": "600","label": "Income Security","size": 15,"color": "#ad494a"},{"name": "650","label": "Social Security","size": 21,"color": "#d6616b"},{"name": "700","label": "Veterans Benefits and Services","size": 3.5,"color": "#e7969c"},{"name": "750","label": "Administration of Justice","size": 2,"color": "#636363"},{"name": "150","label": "International Affairs","size": 1.5,"color": "#969696"},{"name": "800","label": "General Government","size": 1.5,"color": "#bdbdbd"}]}';
//var d = $("#pie_data_44").html();
...
$('input').each(function(index) {
	...
	//console.log(json);
	//	d3.json("data_files/data-2012.json", function(json) {
	vis.selectAll("path")
...
function setReceiptContent(pie, label) {
	...
	for(var i=0; i<pie.children.length; i++) {
		if(pie.children[i].name != "_unallocated") {
			...
			receipt_content += "<div class='receipt_line_item' style='width:180px;float:left'>";
			if(pie.children[i].label == label)   receipt_content += "<strong>";
			receipt_content += pie.children[i].label;
			if(pie.children[i].label == label)   receipt_content += "</strong>";
			receipt_content += "</div>";
			
			receipt_content += "<div class='receipt_line_item' style='width:40px;left:-20px;float:right;text-align:right'>";
			if(pie.children[i].label == label)   receipt_content += "<strong>";
